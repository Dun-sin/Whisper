		...
		<>
			...
			<div className='w-full'>
				<label htmlFor="email" className='w-full flex items-center justify-center'>
					<input type='email' className='w-[80%] max-w-[400px] min-w-[300px] p-3 rounded-md text-black' name='email' ref={emailRef} placeholder='Enter Your Email' />
				</label>
			</div>
			<p className='text-center text-red w-[80%] max-w-[400px] min-w-[300px]'>{error !== '' && error}</p>
			{loading ?
				<p>Creating your account</p> :
				<button onClick={handleSignup} className='bg-highlight w-[80%] max-w-[400px] min-w-[300px] py-2 rounded-md'>Create Account</button>}
		</>
	)
}
