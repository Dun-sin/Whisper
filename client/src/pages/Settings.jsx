					...
					<Form.Group className="flex justify-between" controlId="app-theme">
						<div className="w-5/6">
							<div className="flex">
								<Icon
									...
									className="mr-1.5"
								/>
								<Form.ControlLabel className="text-white text-base font-normal">
									MODE
								</Form.ControlLabel>
							</div>
						...
						<div className="flex items-center">
							<Form.Control
								...
								name="theme"
								accepter={Toggle}
								checked={(settings.theme = settings.theme === undefined ? true : settings.theme)}
						...
						<Animation.Bounce in={hasUnsavedSettings}>
							<div className="w-[100%] flex justify-end mb-3.5 text-xs items-center">
								<Icon
									...
									width="16"
								/>
								<p className="dark:text-highlight text-red text-lg">
						...
						<ButtonToolbar className="flex justify-end">
							<Animation.Fade in={hasUnsavedSettings}>
								<Button
									...
									className="text-base font-normal bg-secondary  w-24 h-9 rounded-md hover:bg-slate-700"
								>
									Cancel
								</Button>
							</Animation.Fade>
