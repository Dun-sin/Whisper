...
const Profile = () => {
    ...
    return (
        ...
        >
            {JSON.parse(localStorage.getItem('auth')).loginType ===
            'anonymous' ? (
                ...
                <>
                    ...
                    <button
                        className="border min-w-[300px] max-w-[400px] w-[40%] p-2 text-md rounded-xl border-green text-green hover:bg-green hover:text-white"
